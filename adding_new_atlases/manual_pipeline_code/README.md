# DIY: Custom vectorized atlases for a given segmentation

<img src="../docs-site/docs/images/custom_vector_method.png" width="60%">

While this package comes with [twelve subcortical and cerebellar atlases](https://anniegbryant.github.io/subcortex_visualization/atlas_info/), you can add any new segmentation (cortical or non-cortical) through three-dimensional (3D) mesh rendering and manual tracing.
This walkthrough will help you through the two key steps for this custom segmentation pipeline:
...
<img src="../docs-site/docs/images/surfice_example.gif" width="70%">
...
<img src="../docs-site/docs/images/inkscape_freehand_lines.png" width="50%">
...
<img src="../docs-site/docs/images/tracing_example.gif" width="70%">
...
<img src="../docs-site/docs/images/trace_outline_combined.png" width="50%">
...
<img src="../docs-site/docs/images/inkscape_region_naming_demo.png" width="80%">
...
<img src="../docs-site/docs/images/Melbourne_S1_both_inkscape.png" width="80%">
...
One of the last steps to get plotting with your custom atlas is to create a lookup table for each of the three SVG images (left, right, and both hemispheres).
...
Adding those lookup tables to your data directory should yield the final file structure for your new atlas:
