...
![aseg subcortical atlas information](images/aseg_atlas_info.png){ width="90%" }
...
![AICHA subcortical atlas information](images/AICHA_subcortical_atlas_info.png){ width="90%" }
...
![Brainnetome subcortical atlas information](images/Brainnetome_subcortex_atlas_info.png){ width="90%" }
...
![CIT168 subcortical atlas information](images/CIT168_subcortex_atlas_info.png){ width="90%" }
...
![Thalamus nuclei (HCP) atlas information](images/Thalamus_Nuclei_HCP_subcortex_atlas_info.png){ width="90%" }
...
![THOMAS thalamus nuclei information](images/Thalamus_THOMAS_atlas_info.png){ width="90%" }
...
![Brainstem Navigator atlas information](images/Brainstem_Navigator_atlas_info.png){ width="90%" }                                  
...
![SUIT cerebellar lobule atlas information](images/SUIT_atlas_info.png){ width="70%" }