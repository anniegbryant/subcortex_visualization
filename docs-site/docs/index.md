...
This package is implemented in both Python (`subcortex_visualization`) and R (`subcortexVisualizationR`) and currently includes the following twelve subcortical (including brainstem + thalamus) and cerebellar atlases for data visualization in two-dimensional vector graphics:
